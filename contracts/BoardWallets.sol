...
import "./interfaces/IBoardWallets.sol";
...
contract BoardWallet is IBoardWallet, OwnableUpgradeable, PausableUpgradeable {
  ...
  // An address can only have one BoardWallet
