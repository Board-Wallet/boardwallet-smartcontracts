...
import type {
  IDynamicVaults,
  IDynamicVaultsInterface,
} from "../../../contracts/interfaces/IDynamicVaults";
...
export class IDynamicVaults__factory {
  static readonly abi = _abi;
  static createInterface(): IDynamicVaultsInterface {
    return new utils.Interface(_abi) as IDynamicVaultsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDynamicVaults {
    return new Contract(address, _abi, signerOrProvider) as IDynamicVaults;
  }
}
